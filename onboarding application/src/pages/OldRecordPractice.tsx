...
export const OldRecordPractice: React.FC = () => {
  ...
  const handleSave = () => {
    handleCloseCamera();
     setIsSaved(true);
     stopRecording();
     setIsPreviewing(true); // Reset preview state
              ...
              <div className='col-md-12 text-center '>
                ...
                <button onClick={handleStartRecording} className='camera-btns-contrl'>Start Recording</button>
                  ...
                  {/* {mediaBlobUrl && <button  className='camera-btns-contrl' onClick={handleSave}>Save</button>} 
                    {isSaved && <button className='camera-btns-contrl'>
                    <a href={mediaBlobUrl} download="recorded-video.webm">Download</a> </button>}
               ...
               <button  className='camera-btns-contrl' onClick={handleSave}>Save</button>
